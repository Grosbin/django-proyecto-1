...
class Empleados(models.Model):
    ...
    id_cargo = models.ForeignKey(CargosEmpleados, models.DO_NOTHING, db_column='id_cargo')
    nombre1 = models.CharField(max_length=30)
    nombre2 = models.CharField(max_length=30, blank=True, null=True)
    apellido1 = models.CharField(max_length=30)
    apellido2 = models.CharField(max_length=30, blank=True, null=True)
...
class Facturas(models.Model):
    ...
    fecha = models.ForeignKey('Ventas', models.DO_NOTHING, db_column='fecha')
...
class ProduccionProductos(models.Model):
    id_producto_produccion = models.ForeignKey('Productos', models.DO_NOTHING, db_column='id_producto_produccion', primary_key=True)
    cantidad = models.IntegerField()
...
class ProveedoresInventario(models.Model):
    ...
    idinventario = models.ForeignKey(Inventario, models.DO_NOTHING, db_column='idInventario')  # Field name made lowercase.
...
class Receta(models.Model):
    id_producto = models.ForeignKey(Productos, models.DO_NOTHING, db_column='id_producto', primary_key=True)
